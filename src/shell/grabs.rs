...
pub struct PointerMoveSurfaceGrab<BackendData: Backend + 'static> {
    pub start_data: PointerGrabStartData<WayiceState<BackendData>>,
    pub window: WindowElement,
    pub initial_window_location: Point<i32, Logical>,
}

impl<BackendData: Backend> PointerGrab<WayiceState<BackendData>> for PointerMoveSurfaceGrab<BackendData> {
    fn motion(
        &mut self,
        data: &mut WayiceState<BackendData>,
        handle: &mut PointerInnerHandle<'_, WayiceState<BackendData>>,
    ...
    fn start_data(&self) -> &PointerGrabStartData<WayiceState<BackendData>> {
        &self.start_data
    }

    fn unset(&mut self, _data: &mut WayiceState<BackendData>) {}
}

pub struct TouchMoveSurfaceGrab<BackendData: Backend + 'static> {
    pub start_data: TouchGrabStartData<WayiceState<BackendData>>,
    pub window: WindowElement,
    pub initial_window_location: Point<i32, Logical>,
}

impl<BackendData: Backend> TouchGrab<WayiceState<BackendData>> for TouchMoveSurfaceGrab<BackendData> {
    fn down(
        &mut self,
        _data: &mut WayiceState<BackendData>,
        _handle: &mut smithay::input::touch::TouchInnerHandle<'_, WayiceState<BackendData>>,
        _focus: Option<(
            <WayiceState<BackendData> as smithay::input::SeatHandler>::TouchFocus,
            Point<f64, Logical>,
        )>,
    ...
    fn up(
        &mut self,
        data: &mut WayiceState<BackendData>,
        handle: &mut smithay::input::touch::TouchInnerHandle<'_, WayiceState<BackendData>>,
    ...
    fn start_data(&self) -> &smithay::input::touch::GrabStartData<WayiceState<BackendData>> {
        &self.start_data
    }
...
impl<BackendData: Backend> PointerGrab<WayiceState<BackendData>> for PointerResizeSurfaceGrab<BackendData> {
    fn motion(
        &mut self,
        data: &mut WayiceState<BackendData>,
        handle: &mut PointerInnerHandle<'_, WayiceState<BackendData>>,
...
impl<BackendData: Backend> TouchGrab<WayiceState<BackendData>> for TouchResizeSurfaceGrab<BackendData> {
    fn down(
        &mut self,
        _data: &mut WayiceState<BackendData>,
        _handle: &mut smithay::input::touch::TouchInnerHandle<'_, WayiceState<BackendData>>,
