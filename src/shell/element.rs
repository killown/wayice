...
impl<BackendData: Backend> PointerTarget<WayiceState<BackendData>> for SSD {
    fn enter(
        &self,
    ...
    fn frame(&self, _seat: &Seat<WayiceState<BackendData>>, _data: &mut WayiceState<BackendData>) {}
    fn leave(
        &self,
        _seat: &Seat<WayiceState<BackendData>>,
        _data: &mut WayiceState<BackendData>,
...
impl<BackendData: Backend> TouchTarget<WayiceState<BackendData>> for SSD {
    fn down(
        &self,
        seat: &Seat<WayiceState<BackendData>>,
        data: &mut WayiceState<BackendData>,
