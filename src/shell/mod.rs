...
impl<BackendData: Backend> BufferHandler for WayiceState<BackendData> {
    fn buffer_destroyed(&mut self, _buffer: &WlBuffer) {}
}

impl<BackendData: Backend> CompositorHandler for WayiceState<BackendData> {
...
impl<BackendData: Backend> WlrLayerShellHandler for WayiceState<BackendData> {
